...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Internamiento.medicoResidente'
        db.add_column('main_internamiento', 'medicoResidente', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Internamiento.medicoResidente'
        db.delete_column('main_internamiento', 'medicoResidente')
