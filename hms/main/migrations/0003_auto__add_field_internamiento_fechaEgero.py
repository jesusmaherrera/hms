...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Internamiento.fechaEgero'
        db.add_column('main_internamiento', 'fechaEgero', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Internamiento.fechaEgero'
        db.delete_column('main_internamiento', 'fechaEgero')
