...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Internamiento.fecha_egreso'
        db.add_column('main_internamiento', 'fecha_egreso', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Internamiento.fecha_egreso'
        db.delete_column('main_internamiento', 'fecha_egreso')
