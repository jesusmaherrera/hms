...
ADMINS = (
    ('Ing. Jésus Manuel Herrera Miramontes', 'sistemashms@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:\django_bd\hms_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'k4##)9*ig--^u1yz81c&@@!kbt6lm^y(f^g5k7=g-z3qi91%of'
